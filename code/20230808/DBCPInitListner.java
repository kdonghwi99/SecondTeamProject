...
public class DBCPInitListner implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce)  { 
    	...
    	try {
    		...
    		// 3. 연결 확인
    		if(con != null) {
    			System.out.println("DBCPInitListner con ok!");
    			...
    			System.out.println("DBCPInitListner con null!");
    		}
    	} catch (Exception e) {
    ...
    public void contextDestroyed(ServletContextEvent sce)  { 
    	// 5. 서버 종료 시 DB 연결 객체 닫기
    		...
    		System.out.println("DBCPInitListner stopped!");
    	}
