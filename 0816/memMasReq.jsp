	...
	<div>
		<main role="main">
			<div class="container divC">
				<form action="/talkdog/Mypage/masInsert.do" method="post" class="form-horizontal"  enctype="multipart/form-data">
				<%System.out.println("신청 넘어감?"); %>
					...
					<div class="form-group row">
						...
						<div
							...
							<input type="submit" class="btn btn-info"  value="등록 신청">
						</div>
						<%System.out.println("신청 넘어감"); %>
				</form>
			</div>
