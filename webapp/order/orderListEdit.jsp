  	...
  	<div class="container"><h2 style="margin: 0 auto;">주문/배송 상세조회</h2></div></section><!-- End Breadcrumbs -->
		...
		<section id="blog" class="blog">
			<div class="container" data-aos="fade-up">
				<form action="./OrderUpdate.do" method="post" class="form-horizontal">
					...
					<div class="entry-meta">
						...
						<div class="entry-content">
							...
							<tr>
								...
								<!-- 처리현황 수정 -->
								<td>
				   				 <select name="ordIngCategory" id="ordIngCategory">
				     			 <option selected disabled class="noCtg">
				     			 <!-- 기존 처리현황 값 --> </option>
				    	  <option>상품준비중</option>
					      <option>반품</option>
					      <option>취소</option>
					      ...
					      <option>구매확정</option>
								...
								<!-- 송장번호 수정 -->
								<td><input type="text" name="invoiceNo" id="invoiceNo" class="form-control"><br>
								</td>
							</tr>
							</tbody>
							</table>
		...
		<!-- ======= 결제 정보 ======= -->
			...
			<input type="submit" id="submit" class="btn btn-white regBtn" style="background-color: #e96b56; color: white" value="수정"/>
			</div>
				</form>
			</div>
		</section>
