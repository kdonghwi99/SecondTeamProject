...
<head>
<meta charset="UTF-8">
<title>orderAdress.jsp</title>

<!-- 사이트의 팝업API호출 소스보기에서 가져온 것 -->
<% 
...
<body onload="init();">
   ...
   function init(){
      ...
      var confmKey = "devU01TX0FVVEgyMDIzMDcxNzE0MDg0MzExMzkzNDI=";   //발급받은 승인키
      var resultType = "4"; // 도로명주소 검색결과 화면 출력유형, 1 : 도로명, 2 : 도로명+지번, 3 : 도로명+상세건물명, 4 : 도로명+지번+상세건물명
      var inputYn= "<%=inputYn%>";      //2 : 도로명+지번, 3: 도로명+상세건물명;
      if(inputYn != "Y"){                        //4: 도로명 + 지번 + 상세건물명;
