...
<%System.out.print("아이디 찾기\n");%>
	<main role="main">
		<div class="container">
		<!--  -->
			<form action="/talkdog/Common/findId.do" method="post" class="form-horizontal">
				<div class="form-group row"
					style="display: flex; justify-content: center; align-items: center;">
					<label class="col-sm-2">이름</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" name="admName"
							id="admName" required value="aaa">
					</div>
				</div>
				...
				<div class="form-group row"
					...
					<div class="col-sm-3">
						<input type="tel" class="form-control" name="admPhone"
							id="admPhone" required value="010-1233-1232">
					</div>
				</div>
				...
				<c:if test="${not empty admId}">
					<div class="alert alert-danger">아이디는 [${admId}]입니다.</div>
