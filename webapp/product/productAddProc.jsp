...
<%
	...
	//ProductDAO의 상품 등록 메서드에 전달한 후
	//처리 결과에 따라 
	//상품 등록에 성공하면 상품 목록 페이지로 이동하고
	//그렇지 않으면 '상품 등록 실패'를 알림창으로 출력한 후
	//			 이전 페이지로 돌아가기
...
int maxSize = 100 * 1024 * 1024; // 최대 업로드 크기를 100MB로 잡음
...
pvo.setpType(multi.getParameter("pType"));
	...
	if(pdao.productEnroll(pvo)==true){							//상품 등록 성공
