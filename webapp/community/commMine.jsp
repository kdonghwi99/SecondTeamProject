		...
		<div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li><a href="/talkdog/Comm/CommList.do?pageNum=1&type=&keyword=&catNo=0&sid=${sessionScope.sid }">전체</a></li>
              <li><a href="/talkdog/Comm/CommList.do?pageNum=1&type=&keyword=&catNo=1&sid=${sessionScope.sid }">사랑(연애/이별/결혼/이혼)</a></li>
              <li><a href="/talkdog/Comm/CommList.do?pageNum=1&type=&keyword=&catNo=2&sid=${sessionScope.sid }">정신건강</a></li>
              <li><a href="/talkdog/Comm/CommList.do?pageNum=1&type=&keyword=&catNo=3&sid=${sessionScope.sid }">취업/학업</a></li>
              <li><a href="/talkdog/Comm/CommList.do?pageNum=1&type=&keyword=&catNo=4&sid=${sessionScope.sid }">인간관계</a></li>
              <li><a href="/talkdog/Comm/CommList.do?pageNum=1&type=&keyword=&catNo=5&sid=${sessionScope.sid }">기타</a></li>
            </ul>
          </div>
        </div>
        <form action="./CommList.do" method="get">
	<div class="row mb-3">
		<div class="col-8"> 
		...
		<!-- 게시물이 없는 경우 -->
		<c:if test="${empty commListPersonal }">
			<div class="row">
		...
		<c:if test="${!empty commListPersonal }">						
			<div>
				...
				<tbody>
				<c:forEach items="${commListPersonal }" var="cmvo">
				<tr>
					<td class="text-center">${cmvo.cmRn }</td>
					<td class="text-center">${cmvo.category }</td>
					<td class="text-center"><a href="./CommView.do?cmNo=${cmvo.cmNo }&admId=test&pageNum=${pageNum }&type=${type }&keyword=${keyword }&catNo=${cmvo.catNo }" >${cmvo.cmTitle }</a></td>
