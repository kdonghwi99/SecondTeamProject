		...
		<div
			...
			<c:if test="${sessionScope.sid == null }">
				<div class="social-links d-none d-md-flex align-items-center">
					...
					<a href="/talkdog/common/login.jsp" class="login">로그인</a> <a
						href="/talkdog/common/join.jsp" class="regi">회원가입</a>
				</div>
			</c:if>

			<c:if test="${sessionScope.sid != null }">
				<li class="nav-item"><a class="nav-link" style="color: white;">[${sessionScope.sid}]님
						환영합니다!</a>
