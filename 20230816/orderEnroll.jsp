<%@ page import="talkdog.dao.OrderDAO, talkdog.dao.PaymentDAO, talkdog.vo.PaymentVO, talkdog.vo.AdminVO" %>
	...
	<main id="main">
		...
		<section id="blog" class="blog">
			<div class="container" data-aos="fade-up">
				<form id="payment-form" action="./Insert.do" method="post" class="form-horizontal">
			...
			<!-- 배송지정보 -->
					...
					<tr>
						<td>${productMap[cvo.pId].pName}</td>
						<td>${cvo.cartOpt }</td>
						<td>${cvo.cartQuan}</td>
...
function requestPay() {
    ...
    var param = {
        ...
        pay_method: 'card',										//결제 수단 : 카드결제
        merchant_uid: new Date().getTime(),   					//주문 번호 생성 
        name: '다들어줄개',										//상품명
        amount: '<c:out value="${ total }"/>',					//결제 금액  payTotal
        buyer_name: '다들어줄개 회원', 		//회원 이름  admName
        buyer_tel: '010-1234-5678',								//회원 번호 admPhone
        buyer_email: 'ha020@naver.com',							//회원 이메일 admEmail
        buyer_addr: '배송지 주소', 								//회원 주소 admAdd1,2,3
